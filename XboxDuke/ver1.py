...
BTN_TO_UINPUT = {
    ...
    'BTN_X': uinput.BTN_X,
    'BTN_Y': uinput.BTN_Y,
    'BTN_BLACK': uinput.BTN_TL2,
    'BTN_WHITE': uinput.BTN_TR2,
    'BTN_START': uinput.BTN_START,
    'BTN_BACK': uinput.BTN_SELECT,
    ...
    try:
        for event in keyboard.read_loop():
            ...
            if event.type == evdev.ecodes.EV_KEY:
                ...
                # Map button presses/releases via dict lookup
                if key in button_map:
...
def mouse_thread():
    ...
    global right_x, right_y, last_mouse_time
...
threads = [
    ...
    threading.Thread(target=stick_center_thread, daemon=True),
