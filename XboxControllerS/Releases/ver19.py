    ...
    for event in keyboard.read_loop():
        ...
        if event.type == evdev.ecodes.EV_KEY:
            ...
            if key == 'KEY_Q':
                ...
                device.emit(uinput.BTN_THUMBR, pressed)  # right stick click mapped to Z now
            elif key == 'KEY_C':
                # No longer used for right stick click, can ignore or add new mapping here if needed
                pass
            elif key == 'KEY_SPACE':
