...
- Mouse movement -> Right thumbstick (ABS_RX, ABS_RY)
- Mouse left/right click -> Left/Right triggers (ABS_Z, ABS_RZ)
- Keyboard keys -> Xbox buttons (A,B,X,Y, bumpers, start, back, d-pad)
- Left thumbstick: W,S,D for up, down, right; A for left (going backward) 
"""
...
# Helper to clamp values 0-255
def clamp(value):
    return max(0, min(255, value))

# Find input device by keyword (case-insensitive)
